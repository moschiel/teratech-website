  ...
  sites: (
    <>
      ...
      <ul className="services-list">
        ...
        <li>
          <b>MEIOS DE PAGAMENTO</b>: para seus clientes fazerem compras online.
        </li>
        <li>
          <b>PAINEL DE CONTROLE</b>: para você atualizar o conteúdo do seu site
          facilmente.
        </li>
      </ul>
    </>
...
function DescriptionServices(props) {
  ...
  return (
    <section className="services" id="services">
      <div className="services-container">{htmlServices}</div>
